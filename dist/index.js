...
var leaflet_map_inline_default = 'var T=Object.defineProperty;var E=(t,n,e)=>n in t?T(t,n,{enumerable:!0,configurable:!0,writable:!0,value:e}):t[n]=e;var r=(t,n,e)=>E(t,typeof n!="symbol"?n+"":n,e);var u={map:{default:{minZoom:"0",maxZoom:"2",zoomDelta:"0.5",zoomSnap:"0.01",height:"600",scale:"1",unit:"",enableCopyTool:"false"}}};async function C(t){for(let n of t)try{await new Promise((e,o)=>{let i=document.createElement("script");i.src=n,i.onload=()=>e(),i.onerror=()=>o(new Error(`Failed to load: ${n}`)),document.head.appendChild(i)});return}catch{}throw new Error(`All CDN sources failed for: ${t.join(", ")}`)}async function x(){typeof L>"u"&&await C(["https://cdn.jsdelivr.net/npm/leaflet@1.9.4/dist/leaflet.js","https://unpkg.com/leaflet@1.9.4/dist/leaflet.js"]),typeof iconify>"u"&&await C(["https://cdn.jsdelivr.net/npm/iconify-icon@3.0.2/dist/iconify-icon.min.js","https://unpkg.com/iconify-icon@3.0.2/dist/iconify-icon.min.js","https://code.iconify.design/iconify-icon/3.0.2/iconify-icon.min.js"])}function M(t){return!t||typeof t!="object"||Array.isArray(t)?!1:Object.keys(t).length>0&&Object.values(t).every(n=>typeof n=="string")}function D(t){let n=t.replace(/\\s/g,"").split(",").map(e=>parseInt(e));if(!P(n))throw new Error("Coordinates not properly validated");return n}function P(t){return!!t&&Array.isArray(t)&&t.length===2&&t.every(n=>typeof n=="number"&&!isNaN(n))}function b(t,n){let e=o=>o*o;return Math.sqrt(e(t.lat-n.lat)+e(t.lng-n.lng))}function Z(t){return!(!M(t)||!t.name||!t.link||!t.coordinates||!t.icon||!t.colour||!t.minZoom)}function A(t){let n=t.querySelectorAll("div.leaflet-marker"),e=[];return n.forEach(o=>{Z(o.dataset)&&e.push(o.dataset),o.remove()}),e}function I(t){return t.replace(/^lucide-/g,"lucide:")}function F(t,n,e){return L.divIcon({className:"leaflet-marker-icon",html:`\n            <a href="${t}">\n                <svg class="leaflet-marker-pin" style="fill:${e}" viewBox="0 0 32 48">\n                    <path d="m32,19c0,12 -12,24 -16,29c-4,-5 -16,-16 -16,-29a16,19 0 0 1 32,0"/>\n                </svg>\n                <iconify-icon class="icon leaflet-marker-inner-icon" icon="${I(n)}" width="19px" height="19px"></iconify-icon>\n            </a>\n        `,iconSize:[32,48],iconAnchor:[16,48],tooltipAnchor:[17,-30]})}function O(t,n){function e(y,S){n.getZoom()>=S-1e-5?y.addTo(n):y.remove()}let{link:o,icon:i,colour:a,minZoom:s,coordinates:l,name:p}=t,k={icon:F(o,i,a)},v=parseFloat(s),g=L.marker(D(l),k).bindTooltip(p);e(g,v),n.on("zoomend",()=>e(g,v))}var d=class{constructor(n){r(this,"index");r(this,"map");r(this,"onSelectCallback",()=>{});r(this,"button");r(this,"options",{...u.map.default,defaultZoom:u.map.default.minZoom,src:""});r(this,"_isSelected",!1);this.index=n.index,this.map=n.map,this.onSelectCallback=n.onSelectCallback}get isSelected(){return this._isSelected}setSelected(n){this._isSelected!==n&&(this._isSelected=n,n?(this.button?.classList.add("selected"),this.onSelected()):(this.button?.classList.remove("selected"),this.onDeselected()))}onAdd(n){this.button=L.DomUtil.create("div","leaflet-control-button",n),this.button.addEventListener("click",()=>this.onSelectCallback(this.index)),L.DomEvent.disableClickPropagation(n),this.onAdded()}onRemove(){this.onRemoved(),this.button?.removeEventListener("click",()=>{}),this.button?.replaceChildren()}updateSettings(n){this.options={...this.options,...n}}onAdded(){throw new Error("Not implemented")}onRemoved(){}onSelected(){}onDeselected(){}mapClicked(n){throw new Error("Not implemented")}},h=class extends d{onAdded(){this.button&&(this.button.innerHTML=\'<iconify-icon icon="lucide:mouse-pointer-2" width="19px" height="19px"></iconify-icon>\',this.button.ariaLabel="Pan")}mapClicked(n){}};var m=class extends d{constructor(){super(...arguments);r(this,"state",0);r(this,"pathItems",[]);r(this,"distance",0);r(this,"lineLayer");r(this,"pointLayer");r(this,"pathLine");r(this,"previewLine");r(this,"previewTooltip");r(this,"lastElement")}onAdded(){this.button&&(this.button.innerHTML=\'<iconify-icon icon="lucide:ruler" width="19px" height="19px"></iconify-icon>\',this.button.ariaLabel="Measure"),this.lineLayer=L.layerGroup().addTo(this.map),this.pointLayer=L.layerGroup().addTo(this.map),this.pathLine=L.polyline([]).addTo(this.lineLayer),this.previewLine=L.polyline([],{dashArray:"8"}).addTo(this.lineLayer),this.previewTooltip=this.getTooltip(!0).setLatLng([0,0])}onSelected(){this.map.getContainer().style.cursor="crosshair",this.map.on("mousemove",e=>{this.renderPreview(e.latlng)})}onDeselected(){this.map.getContainer().style.cursor="",this.map.removeEventListener("mousemove"),this.resetPath(),this.state=0}mapClicked(e){if(!this.lineLayer)throw new Error("Line layer not initialised");switch(this.state){case 0:case 1:{this.state=1,this.pathItems.push(e.latlng),this.renderPath(),this.previewTooltip?.addTo(this.lineLayer),this.renderPreview(e.latlng);break}case 2:{this.state=3,this.lastElement?.bindTooltip(this.getTooltip(!0)).bringToFront(),this.previewTooltip?.remove();break}case 3:this.resetPath(),this.state=0}}renderPath(){this.cleanLastElement(),this.updatePolyline(this.pathLine,this.pathItems);let e=this.pathItems.at(-1);if(e===void 0)return;this.lastElement=this.getCircleMarker(e);let o=this.pathItems.at(-2);o!==void 0&&(this.distance+=b(e,o)*parseFloat(this.options.scale))}renderPreview(e){if(this.state!==1)return;let o=this.pathItems.at(-1);o!==void 0&&(this.updatePolyline(this.previewLine,[o,e]),this.previewTooltip=this.previewTooltip?.setLatLng(e).setContent(this.getContent(this.distance+b(o,e)*parseFloat(this.options.scale))))}resetPath(){this.pathItems=[],this.distance=0,this.cleanLastElement(),this.pointLayer?.clearLayers(),this.updatePolyline(this.pathLine,[]),this.updatePolyline(this.previewLine,[]),this.previewTooltip?.remove()}updatePolyline(e,o){e?.setLatLngs(o).redraw(),e?.getElement()?.classList.remove("leaflet-interactive")}cleanLastElement(){this.lastElement?.removeEventListener("click"),this.lastElement?.getElement()?.classList.remove("leaflet-interactive")}getTooltip(e=!1){return L.tooltip({permanent:e,offset:[15,0]}).setContent(this.getContent(this.distance))}getCircleMarker(e){if(!this.pointLayer)throw new Error("Point layer not initialised");return L.circleMarker(e,{radius:4,fill:!0,fillColor:"#3388ff",fillOpacity:1}).addTo(this.pointLayer).addEventListener("click",()=>this.state=2)}getContent(e){return`${e.toFixed(1)} ${this.options?.unit??u.map.default.unit}`}},f=class extends d{constructor(){super(...arguments);r(this,"previewTooltip")}onAdded(){this.button&&(this.button.innerHTML=\'<iconify-icon icon="lucide:pin" width="19px" height="19px"></iconify-icon>\',this.button.ariaLabel="Copy"),this.previewTooltip=L.tooltip({permanent:!0,offset:[15,0]}).setLatLng([0,0])}onSelected(){this.map.getContainer().style.cursor="crosshair",this.map.on("mousemove",e=>{this.renderPreview(e.latlng)}),this.previewTooltip?.addTo(this.map)}onDeselected(){this.map.getContainer().style.cursor="",this.map.removeEventListener("mousemove"),this.previewTooltip?.remove()}mapClicked(e){navigator.clipboard.writeText(this.getContent(e.latlng))}renderPreview(e){this.previewTooltip?.setContent(this.getContent(e)).setLatLng(e)}getContent(e){return`${Math.round(e.lat)}, ${Math.round(e.lng)}`}},j={enableCopyTool:!1},c=null;function H(){if(c)return c;class t extends L.Control{constructor(o){super({position:"topleft"});r(this,"controls",[]);r(this,"activeIndex",0);r(this,"settings");this.settings={...j,...o}}onAdd(o){this.registerSubControl(h,o),this.registerSubControl(m,o),this.settings.enableCopyTool&&this.registerSubControl(f,o);let i=L.DomUtil.create("div","leaflet-bar leaflet-control");for(let a of this.controls)a.onAdd(i);return this.controls[this.activeIndex]?.setSelected(!0),o.on("click",a=>{for(let s of this.controls)s.isSelected&&s.mapClicked(a)}),i}onRemove(o){o?.removeEventListener("click");for(let i of this.controls)i.onRemove();this.controls=[]}updateSettings(o){for(let i of this.controls)i.updateSettings(o)}registerSubControl(o,i){let a=l=>{this.controls.at(this.activeIndex)?.setSelected(!1),this.controls.at(l)?.setSelected(!0),this.activeIndex=l},s={index:this.controls.length,map:i,onSelectCallback:a};this.controls.push(new o(s))}}return c=t,c}function R(t){return M(t)?["src","height","minZoom","maxZoom","defaultZoom","zoomDelta","scale","unit"].every(e=>typeof t[e]=="string"):!1}async function N(t){return new Promise((n,e)=>{let o=new Image;o.onload=()=>n(o),o.onerror=i=>e(i),o.src=t})}async function $(t,n){let e=t.dataset;if(!R(e))return;let o=await N(e.src);t.style.aspectRatio=(o.naturalWidth/o.naturalHeight).toString();let i=[[0,0],[o.naturalHeight,o.naturalWidth]],a=L.map(t,{crs:L.CRS.Simple,maxBounds:i,minZoom:parseFloat(e.minZoom),maxZoom:parseFloat(e.maxZoom),zoomSnap:.01,zoomDelta:parseFloat(e.zoomDelta)}),s=H(),l=new s({enableCopyTool:e.enableCopyTool==="true"});return l.addTo(a),l.updateSettings(e),L.imageOverlay(e.src,i).addTo(a),a.fitBounds(i),n.map(p=>O(p,a)),a.setZoom(parseFloat(e.defaultZoom)),a}function z(t){t?.clearAllEventListeners(),t?.remove()}async function w(){let t=document.querySelectorAll("div.leaflet-map");if(t.length!==0){try{await x()}catch(n){console.error("[leaflet-map] Failed to load dependencies:",n);for(let e of Array.from(t))e.textContent="Failed to load map dependencies. Check your browser\'s content blocking settings.";return}for(let n of Array.from(t)){let e=A(n),o=await $(n,e);window.addCleanup(()=>z(o))}}}document.addEventListener("nav",w);document.addEventListener("render",w);\n';
